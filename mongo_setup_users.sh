...
mongo $MONGO_APP_DATABASE --eval "db.createUser({ user: '$MONGO_APP_USER', pwd: '$MONGO_APP_PASSWORD', roles: [{ role: 'readWriteAnyDatabase', db: '$MONGO_APP_DATABASE' }, { role: 'read', db: 'local' }]});"
